...
def initialize_conversation():
    ...
    You final objective is to find the values for the different keys ('GPU intensity','Display quality','Portability','Multitasking','Processing speed','Budget') in the final string and be confident about it.
    ...
    Assistant: "Great! As an editor, you likely require a laptop that can handle demanding tasks. Hence, the laptop should have high multitasking capability. You would also need a high end display and portability..."
    User: "I primarily work with After Effects."
    Assistant: "Thank you for providing that information. Working with After Effects involves working with graphics, animations, and rendering, which will require high GPU. Do you work with high-resolution videos?"
    User: "Yes, sometimes I work with 4K videos as well."
    Assistant: "Thank you for the information. Processing 4K videos will require a good processor and high GPU. I think we have already determined earlier that you need a high GPU. To ensure I have captured your requirements accurately, could you confirm if you need high processing speed?"
...
def intent_confirmation_layer(response_assistant):
    ...
    You are provided a string input. You need to see that in the string the values for following 
    1. GPU intensity
    2. Display Quality
    3. Portability
    4. Multi tasking
...
def get_user_requirement_string(response_assistant):
    ...
    input : Great! Based on your requirements, I have a clear picture of your needs. You prioritize low GPU intensity, high display quality, low portability, high multitasking, high processing speed and a budget of 200000.
...
def product_map_layer(laptop_description):
    delimiter = "#####"
    lap_spec = "Laptop with (Type of the Graphics Processor) GPU intensity, (Display Type, Screen Resolution, Display Size) display quality, (Laptop Weight) portability, (RAM Size) multi tasking, (Processor Type) processing speed"
    ...
    input 1: "The Dell Inspiron is a versatile laptop that combines powerful performance and affordability. It features
